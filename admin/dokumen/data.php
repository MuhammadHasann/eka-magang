...
while ($data = mysqli_fetch_array($query)) {
              ...
              <tr>
                ...
                <td class="project-actions text-right">
                          <a class="btn btn-info btn-sm" href="?page=edit_data&&id=<?= $data['id_dokumen'] ?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" href="#" onClick="confirm_modal('?page=hapus_data&&id=<?= $data['id_dokumen'] ?>');">
