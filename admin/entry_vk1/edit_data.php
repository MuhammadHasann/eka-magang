<?php
$id = $_GET['id'];
$select = mysqli_query($koneksi, "SELECT * FROM petugas WHERE id_petugas = '$id'");
...
if (isset($_POST['save'])) {
  ...
  $query = mysqli_query($koneksi, "UPDATE entry_vk1 
  SET id_entry_vk1 = '$id_entry_vk1',  = kabupaten = '$kabupaten', kecamatan = '$kecamatan', desa = '$desa', nama_sls = '$nama_sls',
   pml = '$pml', ppl = '$ppl'
  WHERE id_entry_vk1 = '$id'");
  if ($query) {
?>
    <script>
