...
if (isset($_POST['save'])) {
  ...
  $query = mysqli_query($koneksi, "INSERT INTO entry_vk1
  
  SET id_dokumen = '$id_dokumen', koseka = '$koseka', pml = '$pml', ppl = '$ppl'");
  if ($query) {
?>
    <script>
      window.location = "data_sudah_entry.php?msg=success";
    </script>
  <?php
  } else {
