...
<?php if (isset($_POST['print'])) {
      $tahun = $_POST['tahun'];
      ?>
          <a href="../print/print_data_tidak_miskin.php?tahun=<?= $tahun ?>" target="_blank" class="btn btn-app">
                  <i class="fas fa-print"></i> Print
                </a>
                <?php } ?>
                <?php  $query = mysqli_query($koneksi, "SELECT * FROM data_entry 
                INNER JOIN data_miskin ON data_entry.id_data_entry = data_miskin.id_data_entry WHERE data_miskin.kategori_miskin = 'Tidak Miskin'");
                if (isset($_POST['print'])) {
                
                  $query = mysqli_query($koneksi, "SELECT * FROM data_entry 
                  INNER JOIN data_miskin ON data_entry.id_data_entry = data_miskin.id_data_entry WHERE data_miskin.kategori_miskin = 'Tidak Miskin' AND data_entry.tahun = '$tahun'");
                }?>
