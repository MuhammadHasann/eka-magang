...
if (isset($_POST['save'])) {
  ...
  $query = mysqli_query($koneksi, "UPDATE petugas SET kabupaten = '$kabupaten', kecamatan = '$kecamatan',desa = '$desa',
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>ppl</label>
              <input type="number" name="ppl
              " value="<?= $d['ppl'] ?>" class="form-control" required>
            </div>
              </select>
            </div>
